...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    location = make_city('temp', lat, lon)
    if distance(city1, location) < distance(city2, location):
...
def add_trees(t1, t2):
    ...
    if len1 == len2:
        ...
        new_branch = branches(t1) + [tree(0) for _ in range(len2 - len1)]
