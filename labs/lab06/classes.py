...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        other_attack, other_defense = other_card.attack, other_card.defense
        for card in player.deck.cards:
            card.attack += other_attack
            card.defense += other_defense
        opponent.deck.cards = list(filter(lambda x: x.attack != other_attack and x.defense != other_defense, opponent.deck.cards))
